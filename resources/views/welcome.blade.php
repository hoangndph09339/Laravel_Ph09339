...
<h2>Route name voi parameter co tham so truyen vao</h2>
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <ul class="navbar-nar mr-auto">
        <a href="{{Route('user.branch', ['id' => 1, 'brId' => "HN"])}}">
            <li class="nav-item">user Branch 1</li>
        </a>
        <a href="{{Route('user.branch', ['id' => "2", 'brId' => "HCM"])}}">
            <li class="nav-item">User Branch 2</li>
        </a>
        <a href="{{Route('user.branch', ['id' => 3, 'brId' => "QC"])}}">
            <li class="nav-item">User Branch 3</li>
        </a></ul>
</nav>
<br>
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <ul class="navbar-nar mr-auto">
        <a href="{{Route('user.show', ['id' => 1])}}">
            <li class="nav-item">user 1</li>
        </a>
        <a href="{{Route('user.show', ['id' => 2])}}">
            <li class="nav-item">User 2</li>
        </a>
        <a href="{{Route('user.show', ['id' => 3])}}">
            <li class="nav-item">User 3</li>
        </a></ul>
</nav>
<h1>Route Group Prefix</h1>
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <ul class="navbar-nar mr-auto">
        ...
        <a href="{{Route('backend.products')}}">
            <li class="nav-item">Product management</li>
        </a>
        <a href="{{Route('backend.categories')}}">
            <li class="nav-item">Category management</li>
        </a>
        <a href="{{Route('backend.news')}}">
            <li class="nav-item">News management</li>
        </a>
    </ul>
</nav>
<h1>Namespace</h1>
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <ul class="navbar-nar mr-auto">
        <a href="{{Route('backend.user')}}">
            <li class="nav-item">User management Controller</li>
        </a>
        <a href="{{Route('backend.product')}}">
            <li class="nav-item">Product management Controller</li>
        </a>
        <a href="{{Route('backend.category')}}">
            <li class="nav-item">Category management Controller</li>
        </a>
        <a href="{{Route('backend.new')}}">
            <li class="nav-item">News management Controller</li>
        </a>
    </ul>
</nav>
